...
class PersonaTest extends ModeloTestCase
{
    ...
    public function test_factory(): void
    {
        ...
        $this->assertNotNull($this->inst, 'No se funcionó el factory()->make()');
        $this->inst->save();
        ...
        $this->assertNotNull($this->inst, 'No se funcionó el factory()->create()');
        $this->assertDatabaseHas($this->table, $this->inst->getRawOriginal());
        $this->reg = Persona::findOrFail($this->inst->id);
        $this->assertNotNull($this->reg, 'No se pudo extraer el registro');
    ...
    public function test_update(): void
    {
        ...
        Persona::where('id', $this->inst->id)->update(['nombres' => $this->inst->nombres]);
        $this->assertDatabaseHas($this->table, $this->inst->getRawOriginal());
        $this->assertDatabaseCount($this->table, 1);
    }
    public function test_delete(): void
    {
        ...
        $this->assertDatabaseMissing($this->table, $this->inst->getRawOriginal());
