...
class Create extends Page
{
    ...
    public function elements(): array
    {
        return [
            ...
            '@ropo-form' => '#ropo-form',
            '@ropo.tipo' => '#ropo-form #ropo_tipo + select',
            '@ropo.tipo-message' => '#ropo-form #ropo_tipo-message',
            '@ropo.caducidad-btn' => 'button#ropo_caducidad-btn',
            '@ropo.caducidad-value' => '#ropo-form #ropo_caducidad-value',
            '@ropo.caducidad-input' => '#ropo-form #ropo_caducidad-input',
            '@ropo.caducidad-calendar' => 'div#ropo_caducidad-calendar',
            '@ropo.caducidad-message' => '#ropo-form #ropo_caducidad-message',
            ...
            '@ropo.tipo_aplicador-message' => '#ropo-form #tipo_aplicador-message',
