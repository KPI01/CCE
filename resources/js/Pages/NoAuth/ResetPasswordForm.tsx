...
export default function ResetPasswordForm({ token }: Props) {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        console.log('onSubmit(): confirmación clave: ', values.password === values.password_confirmation)
    ...
    return (
        <NoAuthLayout>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="lg:text-4xl">Restablecimiento de clave</CardTitle>
                    <CardDescription className="lg:text-xl">Ingresa tu correo, la nueva clave y luego debes confirmarla.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
