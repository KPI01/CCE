...
import { CAPACITACIONES, CONTAINER_CLASS, formSchema, PERFILES } from "./formSchema";
import { z } from "zod";
...
export default function Edit({ data, urls }: Props) {
    ...
    return (
        ...
        >
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className={CONTAINER_CLASS}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItemSelectConstructor
                                    ...
                                    onChange={field.onChange}
                                    value={field.value || ""}
                                    {...field.value === null && { placeholder: "Sin seleccionar." }}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormDatePickerConstructor
                                    ...
                                    resetBtn
                                    resetFn={() => form.setValue(field.name, null, {
                                        shouldValidate: true,
                                        shouldDirty: true,
                                        shouldTouch: true
                                    })}
