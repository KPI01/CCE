...
export default function ConfirmEmailDialog({ canOpen, open, callback }: Props) {
      ...
      <AlertDialog open={open}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Se ha enviado un link a tu correo con el cual podrás verificar tu
              cuenta y comenzar a utilizar la aplicación.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
