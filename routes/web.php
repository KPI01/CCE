...
// Rutas de la app
Route::prefix("/cce")->group(function () {
    ...
    Route::prefix("auth")->group(function () {
        ...
        Route::controller(UserController::class)->group(function () {
            Route::middleware("guest")->group(function () {
                ...
                Route::post("/login", "login")->name("login.usuario");
                Route::get("/registro", "register_form")->name("registro");
                Route::post("/registro", "store")->name("store.usuario");
            });
            ...
            Route::prefix("correo")
                ...
                ->group(function () {
                    ...
                    Route::get("/validar", "confirm_email_form")->name(
                        "verification.notice"
                    );
            ...
            Route::prefix("clave")
                ->middleware("guest")
                ->group(function () {
                    Route::get("/olvido", "reset_pass_request_form")->name(
                        "password.request"
                    );
                    Route::post("/olvido", "reset_pass_request")->name(
                        "password.email"
                    );
